<template>
    <div class="address-update">
        <div class="address-update-title">修改地址</div>
        <div>
        ...
        <div class="btn-container">
            <button @click="ok" class="ok">更新</button>
...
<script>
    export default {
        ...
        async created() {
            ...
            this.model = await this.$api.address.getModel(id)
        },
        methods: {
            async ok() {
                await this.$api.address.update(this.model)
                this.$Alert('更新成功')
